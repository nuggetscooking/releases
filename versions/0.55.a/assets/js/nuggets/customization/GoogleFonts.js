...
const GoogleFont = { 
	...
	initiatize: () => {
		if ( null===Query(document,'link', ['rel','preconnect']) ) { 
			Query(document,"head").appendChild(createLinkNode('preconnect',"https://fonts.googleapis.com"));
			Query(document,"head").appendChild(createLinkNode('preconnect',"https://fonts.gstatic.com")).setAttribute("crossorigin", "");
		}
	},
